...
public class ArrayFunHouseRunner
{
	public static void main( String args[] )
	{
		...
		System.out.println("New Array With 7's replaced with 0's: " + Arrays.toString(ArrayFunHouse.removeVal(one, 7)));
		...
		System.out.println("New Array With 7's replaced with 0's: " + Arrays.toString(ArrayFunHouse.removeVal(two, 7)));
